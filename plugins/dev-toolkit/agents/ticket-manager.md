...
1. **Check project docs first:**
   ...
   - `.claude/dev-toolkit.local.md` for ticketing configuration
...
**Configuration format in `.claude/dev-toolkit.local.md`:**
```yaml
ticket_system:
  type: mcp
...
**Actions:**
1. Check for `.claude/dev-toolkit.local.md` configuration
...
Suggestion: Verify ticket ID or check configuration in .claude/dev-toolkit.local.md
```
...
Fallback Options:
1. Configure API scripts in .claude/dev-toolkit.local.md
