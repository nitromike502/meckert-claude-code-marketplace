...
**Development Agents:**
- `dev-toolkit:backend-developer` - Backend implementation
- `dev-toolkit:frontend-developer` - Frontend implementation
- `data-parser` - Data parsing and utilities
- `dev-toolkit:test-runner` - Test implementation

**Coordination Agents:**
- `dev-toolkit:git-expert` - All git operations (commits, branches, PRs, merges)
- `dev-toolkit:subagent-orchestrator` - Task delegation and workflow coordination
- `dev-toolkit:code-reviewer` - Code quality and standards review
- `dev-toolkit:documenter` - Documentation updates
...
For SWARM-based development workflows, use the `/dev-toolkit:swarm` command to launch coordinated multi-agent tasks.
