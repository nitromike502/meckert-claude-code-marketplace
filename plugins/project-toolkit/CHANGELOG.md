...
All notable changes to the project-toolkit plugin will be documented in this file.
...
### Changed
- All subagent references now use plugin namespace prefix (e.g., `project-toolkit:backend-developer`)
- All slash command references now use plugin namespace prefix (e.g., `/project-toolkit:swarm`)
- Renamed `agile-ticket-manager` to `project-toolkit:ticket-manager` for consistency
